package net.venarge.network.chat;
...
public class HoverEvent {
    ...
    public static class Action<T> {
        ...
        private static final Map<String, Action<?>> LOOKUP = Stream.of(SHOW_TEXT, SHOW_ITEM, SHOW_ENTITY).collect(ImmutableMap.toImmutableMap(HoverEvent.Action::getName, (p_178444_) -> {
            return p_178444_;
        }));
