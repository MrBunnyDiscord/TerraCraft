package net.venarge.terracraft.util.jarhandling;
...
public class ModuleClassLoader extends ClassLoader{
    ...
    private Class<?> readerToClass(final ModuleReader reader, final ModuleReference ref, final String name) {
        ...
        ProtectionDomainHelper.tryDefinePackage(this, name, modroot.jar().getManifest(), t->modroot.jar().getManifest().getAttributes(t), this::definePackage);
