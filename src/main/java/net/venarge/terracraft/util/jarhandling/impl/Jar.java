package net.venarge.terracraft.util.jarhandling.impl;

import net.venarge.terracraft.util.jarhandling.JarMetadata;
import net.venarge.terracraft.util.jarhandling.SecureJar;
import net.venarge.terracraft.util.jarhandling.SecureJar.Status;
import net.venarge.terracraft.util.jarhandling.SecureJar.Provider;
import net.venarge.terracraft.util.jarhandling.cl.LambdaExceptionUtils;
import net.venarge.terracraft.util.jarhandling.union.UnionFileSystem;
import net.venarge.terracraft.util.jarhandling.union.UnionFileSystemProvider;
...
public class Jar {
    ...
    private record StatusData(String name, SecureJar.Status status, CodeSigner[] signers) {
        static void add(final String name, final SecureJar.Status status, final CodeSigner[] signers, Jar jar) {
    ...
    public Jar(final Supplier<Manifest> defaultManifest, final Function<SecureJar, JarMetadata> metadataFunction, final BiPredicate<String, String> pathfilter, final Path... paths) {
        ...
        this.metadata = metadataFunction.apply (SecureJar.from (metadataFunction));
    }
    ...
    public SecureJar.Status verifyPath(final Path path) {
